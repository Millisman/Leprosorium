...
//     SPI_Master_Transfer_Tx(pBuf, count);
...
uint8_t nRF24_Check(void) {
    ...
    nRF24_WriteMBReg(nRF24_CMD_W_REGISTER | nRF24_REG_TX_ADDR, ptr, 3);
    nRF24_ReadMBReg(nRF24_CMD_R_REGISTER | nRF24_REG_TX_ADDR, rxbuf, 3);
