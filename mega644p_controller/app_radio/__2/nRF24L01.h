...
#define true    1
     ...
     * when init is called to make the transition to PTX mode simpler.
     */
     ...
     */
    bool nRF24L01_write( const void* buf, uint8_t len );
    ...
    void nRF24L01_openReadingPipe(uint8_t number, const uint8_t *address);
...
//     void nRF24L01_printDetails(void);
     ...
     */
    bool nRF24L01_write_M( const void* buf, uint8_t len, const bool multicast );
     ...
     * @return True if the payload was delivered successfully false if not
     */
    bool nRF24L01_writeFast( const void* buf, uint8_t len );
     ...
     */
    bool nRF24L01_writeFast_M( const void* buf, uint8_t len, const bool multicast );
...
//     bool nRF24L01_txStandBy(uint32_t timeout);
     ...
     */
    bool nRF24L01_isAckPayloadAvailable(void);
...
//
     ...
     * @return True if the payload was delivered successfully false if not
     */
    void nRF24L01_startFastWrite( const void* buf, uint8_t len, const bool multicast );
...
// // // //     uint8_t nRF24L01_flush_tx(void);
     ...
     */
    bool nRF24L01_testCarrier(void);
     ...
     */
    void nRF24L01_maskIRQ(bool tx_ok,bool tx_fail,bool rx_ready);
...
// // // // #endif
     ...
     */
    void nRF24L01_openReadingPipe_64(uint8_t number, uint64_t address);
     ...
     * @param address The 40-bit address of the pipe to open.
     */
    void nRF24L01_openWritingPipe64(uint64_t address);
...
//     void csn(bool mode);
     ...
     * @return Current value of status register
     */
    uint8_t _nRF24L01_write_payload(const void* buf, uint8_t len, const uint8_t writeType);
     ...
     * @return Current value of status register
     */
    uint8_t _nRF24L01_read_payload(void* buf, uint8_t len);
...
// // // //     uint8_t nRF24L01_flush_rx(void);
     ...
     * @return Current value of status register
     */
    uint8_t _nRF24L01_get_status(void);
     ...
     * @warning Does nothing if stdout is not defined.  See fdevopen in stdio.h
     */
    void _nRF24L01_print_status(uint8_t status);
     ...
     * @warning Does nothing if stdout is not defined.  See fdevopen in stdio.h
     */
    void _nRF24L01_print_observe_tx(uint8_t value);
     ...
     */
    void _nRF24L01_print_byte_register(const char* name, uint8_t reg, uint8_t qty);
     ...
     * @param qty How many successive registers to print
     */
    void _nRF24L01_print_address_register(const char* name, uint8_t reg, uint8_t qty);
     ...
     */
    void _nRF24L01_toggle_features(void);
    
    /**
     * Built in spi transfer function to simplify repeating code repeating code
     */
    
    uint8_t _nRF24L01_spiTrans(uint8_t cmd);
