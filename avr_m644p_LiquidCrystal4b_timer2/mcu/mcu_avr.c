    ...
    if ( __counter_10 >= 10) {
        ...
        switch (__lcd4b_state) {
            ...
            case LCD_4b_HIGH: {
                ...
                mcu_lcd_write4b(a);
//                 if ((a >> 0) & 0x01) { ON(PIN_LCD_D4); } else { OFF(PIN_LCD_D4); }
//                 if ((a >> 1) & 0x01) { ON(PIN_LCD_D5); } else { OFF(PIN_LCD_D5); }
//                 if ((a >> 2) & 0x01) { ON(PIN_LCD_D6); } else { OFF(PIN_LCD_D6); }
//                 if ((a >> 3) & 0x01) { ON(PIN_LCD_D7); } else { OFF(PIN_LCD_D7); }
